                                ...
                                <tr>
                                    ...
                                    <td>
                                        @php
                                            ...
                                            // Check if there are approved boron analyses (guarded by column existence)
                                            $boronAnalyses = 0;
                                            try {
                                                if (\Illuminate\Support\Facades\Schema::hasColumn('boron_analysis_details', 'review_status')) {
