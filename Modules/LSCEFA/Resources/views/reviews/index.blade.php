        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <form action="{{ route('lscefa.quality.reviews.index') }}" method="GET" class="float-right filter-form">
                            <div class="row">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="muestra" class="form-control" 
                                           placeholder="Filtrar por muestra..." value="{{ request('muestra') }}">
                                </div>
                                <div class="col-md-4">
                                    <div class="input-group">
                                        <input type="text" name="q" class="form-control"
                                               placeholder="Buscar por consecutivo o cliente..." value="{{ request('q') }}">
                            ...
                            <div class="row mt-2">
                                <div class="col-md-12 text-right">
                                    <a href="{{ route('lscefa.quality.reviews.index') }}" class="btn btn-secondary btn-sm">
                        ...
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <h3 class="card-title mb-0">
                                    ...
                                    <span
                                        class="badge bg-dark analysis-type-badge">{{ $analysis->service_name ?? ucfirst($analysis->type) }}</span>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4 text-right">
                                    ...
                                    @else
                                        <a href="{{ route('lscefa.quality.reviews.show', ['id' => $analysis->id, 'type' => $analysis->type]) }}"
                                            class="btn btn-primary"
                                            onclick="window.location.href='{{ route('lscefa.quality.reviews.show', ['id' => $analysis->id, 'type' => $analysis->type]) }}'; return false;">
...
$(document).ready(function() {
    // Asegurar que los botones de revisión funcionen correctamente
    $('.btn-primary[href*="reviews/show"]').on('click', function(e) {
        e.preventDefault();
    ...
    // Log para debugging
    console.log('Script de revisiones cargado correctamente');
});
</script>
@endpush
