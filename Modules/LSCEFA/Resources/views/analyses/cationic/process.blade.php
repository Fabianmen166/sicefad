...
@section('title', 'Análisis de Intercambio Catiónico')
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Formulario de Análisis de Intercambio Catiónico</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('lscefa.technical.analyses.cationic.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="process_id">ID del Proceso</label>
                                    <input type="text" class="form-control" id="process_id" name="process_id" 
                                           value="{{ $process->process_id }}" readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="service_id">ID del Servicio</label>
                                    <input type="text" class="form-control" id="service_id" name="service_id" 
                                           value="{{ $service->services_id }}" readonly>
                                </div>
                            </div>
                        </div>
