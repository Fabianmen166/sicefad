                                ...
                                @forelse($processes as $process)
                                    ...
                                    @if($cationicService && $cationicService->status === 'pending')
                                        <tr data-process-id="{{ $process->process_id }}" data-service-type="cation_exchange">
                                            ...
                                            <td>{{ $cationicService->service->descripcion ?? 'Intercambio Catiónico' }}</td>
                                            <td><span class="badge badge-warning">Pendiente</span></td>
                                            <td>
                                                <a href="{{ route('lscefa.technical.analyses.cationic.process', ['processId' => $process->process_id, 'serviceId' => $cationicService->service_id]) }}"
...
<script>
    $(document).ready(function() {
        ...
        $('#processSelectedBtn').on('click', function() {
            ...
            var form = $('<form>', {
                'method': 'POST',
                'action': '{{ route('lscefa.technical.analyses.cationic.batch.post') }}'
            });
