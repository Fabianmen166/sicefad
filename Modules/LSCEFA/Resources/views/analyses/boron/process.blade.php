                                ...
                                <table class="table table-bordered table-hover" id="items_ensayo_table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input type="number" step="any" class="form-control" name="items[0][boro_disponible_mg_l]"></td>
                                            <td><input type="number" step="any" class="form-control" name="items[0][boro_disponible_mg_kg]" readonly></td>
        ...
        $('#add_item_row').click(function() {
            ...
            let newRow = `
                <tr>
                    ...
                    <td><input type="number" step="any" class="form-control" name="items[${itemRowIndex}][boro_disponible_mg_l]"></td>
                    <td><input type="number" step="any" class="form-control" name="items[${itemRowIndex}][boro_disponible_mg_kg]" readonly></td>
